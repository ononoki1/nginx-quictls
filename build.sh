...
--with-openssl-opt="-Wl,-ljemalloc -O3 -pipe -flto enable-ktls no-comp enable-ec_nistp_64_gcc_128 no-ssl3-method no-tls1-method no-tls1_1-method no-dtls1-method no-dtls1_2-method" \
--with-cc-opt="-O3 -pipe -flto" \
